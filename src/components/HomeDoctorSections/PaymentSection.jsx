...
const PaymentSection = () => {
  ...
  return (
    <div className="flex w-[98%] flex-col items-center gap-10">
      <div className="flex w-full flex-col items-center justify-center gap-5 px-6 text-center">
      ...
      <div className="flex w-[96%] flex-wrap items-center justify-center gap-5 3xl:max-w-[130rem]">
        ...
        <div className="pt-5 text-center">
          <Text className="text-center font-poppins text-3xl font-semibold">
            Cadastre-se e conheça nossa plataforma por 30 dias grátis
          </Text>
          <a href="/sign_up" className="mx-auto w-fit">
            <Button
              label="Teste Grátis"
